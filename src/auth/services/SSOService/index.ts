...
export default class SSOService {
     ...
     */
    static async loginOrCreateUser(profile: any, accessToken: string, refreshToken: string, provider: string): Promise<SafeUser> {
        if (!profile.email) {
     ...
     * @param code - The code.
     */
    static async handleGoogleCallback(code: string): Promise<SafeUser> {
        try {
     ...
     * @param code - The code.
     */
    static async handleAppleCallback(code: string): Promise<SafeUser> {
        try {
     ...
     * @param code - The code.
     */
    static async handleFacebookCallback(code: string): Promise<SafeUser> {
        try {
     ...
     * @param code - The code.
     */
    static async handleGithubCallback(code: string): Promise<SafeUser> {
        try {
     ...
     * @param code - The code.
     */
    static async handleLinkedInCallback(code: string): Promise<SafeUser> {
        try {
     ...
     * @param code - The code.
     */
    static async handleMicrosoftCallback(code: string): Promise<SafeUser> {
        try {
