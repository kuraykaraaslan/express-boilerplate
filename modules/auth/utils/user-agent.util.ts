...
export default class UserAgentUtil {
  ...
  public static parseRequest(request: Request): UserAgentData {
    ...
    const ip = typeof rawIpStr === 'string' ? rawIpStr.split(',')[0].trim() : null;
    return UserAgentUtil.parse(userAgent, ip ?? undefined);
  }
